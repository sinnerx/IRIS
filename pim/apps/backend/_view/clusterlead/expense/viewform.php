...
<div class='row'>
  <div class='col-sm-12'>
   ...
   <form class="form-inline bs-example " method='post' action='<?php echo url::base('expense/listStatus/');?>'>
          ...
          <div class='row'>
            <div class='col-sm-12'>
              ...
              <tbody>
                ...
                <tr>
                  <td>Done</td>
                  <td><button name="submit" type="submit" value='1' class="btn btn-sm btn-default">Done</button></td>
                  <td>Done</td>
                </tr>
