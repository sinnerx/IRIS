			...
			<div class='panel-body'>
				<form method='post' id='theForm' action=''>
					<div class='form-group'>
						...
						<?php echo form::select("clusterID",$clusters,"class='form-control' $disabled",$cluster->clusterID);?>
						<?php echo flash::data("clusterID");?>
					</div>
					<div class='form-group'>
						<label>Available User <a href='<?php echo url::base("user/add?level=4");?>' class='fa fa-plus-circle' target="_blank"></a></label>
						<?php $disabled	= $userID?"disabled":"";?>
						<?php echo form::select("userID",$users,"$disabled class='form-control'",$userID);?>
