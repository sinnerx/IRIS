		...
		<section class='panel panel-default'>
			...
			<div class='panel-body'>
				<div class='tab-content'>
					...
					<?php if(!$res_article):?>
					There's no related blog written about this activity yet. Or you may <a target='_blank' href='<?php echo url::base("site/addArticle?reportfor=".$activityID);?>'>write a new report article</a> or <a data-toggle='ajaxModal' href='<?php echo url::base('ajax/article/lists/'.$activityID);?>'>choose from a list just as a reference</a> for this activity.
					<?php else:?>
