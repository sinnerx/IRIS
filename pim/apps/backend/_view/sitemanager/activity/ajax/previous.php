					...
					<div class='row'>
						<div class='col-sm-12' style="margin:auto;">
							...
							<?php 
								...
								if($previous){
									echo '<li><a href="'.$url.'/'.$articleID.'?year='.$previousyear.'&month='.$previousmonth.'&ref='.$ref.'"><i class="fa fa-chevron-left"></i></a></li>';
								} 
								if($next){ 
									echo '<li><a href="'.$url.'/'.$articleID.'?year='.$nextyear.'&month='.$nextmonth.'&ref='.$ref.'"><i class="fa fa-chevron-right"></i></a></li>';
								} 
							?>
								</ul>
