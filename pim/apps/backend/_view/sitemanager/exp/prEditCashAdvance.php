...
<div class='row'>
  ...
  <form class="form-inline bs-example " method='post' action='<?php echo url::base('exp/prEditCashAdvanceSubmit/'.$cashAdvanceID);?>'>
          <div class="table-responsive ">
            <table class="table table-striped b-t b-light">
              ...
              <thead>
                ...
                <td colspan="2" rowspan="3"><textarea style="height: 115px;" rows="2" cols="100" name="purpose"></textarea></td>
                <?php } else { ?>
                <td colspan="2" rowspan="3"><textarea style="height: 115px;" rows="2" cols="100" name="purpose" disabled="disabled"><?php echo $cashadvance[0][purchaseRequisitionCashAdvancePurpose] ?></textarea></td>
                <?php } ?>
