...
<div class='row'>
  ...
  <form class="form-inline bs-example " method='post' action='<?php echo url::base('expense/submitReconciliation/'.$prId);?>'>
...
<a href="<?php echo url::base("expense/uploadFile/".$prId); ?>"  class='fa fa-plus-square-o pull-right' data-toggle="ajaxModal" style="color:green; float:right"> Add File</a>
          ...
          <div class='row'>
            <div class='col-sm-12'>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                  <?php if ($smstatus == "Done") {  ?>
                  <button id="check" name="check" type="submit" class="btn btn-sm btn-default" value="2">Done</button>
                  <?php  } else { ?>
                  <button id="check" name="check" type="submit" class="btn btn-sm btn-default" value="1">Submit</button>
                  <?php } ?>
                  </td>
