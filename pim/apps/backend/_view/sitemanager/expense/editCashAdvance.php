...
<div class='row'>
  ...
  <form class="form-inline bs-example " method='post' action='<?php echo url::base('expense/updateCashAdvance/'.$prId);?>'>
          <div class="table-responsive ">
            <table class="table table-striped b-t b-light">
              ...
              <thead>
                ...
                <?php } else { ?>
                <td colspan="2"><textarea rows="2" cols="100" name="purpose"><?php echo $cashadvance[0][purchaseRequisitionCashAdvancePurpose] ?></textarea></td>
                <?php } ?>
            ...
            <table class="table table-striped b-t b-light" >
              <tbody id="p_scents">
                ...
                <tr id = "<?php echo $key + 1 ?>">                  
                  ...
                  <td><textarea rows="2" cols="100" name="item[itemRemark][<?php echo $key + 1 ?>]"><?php echo $list[purchaseRequisitionCashDetailItem] ?></textarea></td>
                  <td></td>
                  <td><input name="item[itemPrice][<?php echo $key + 1 ?>]" type="text" size="5" class="form-control" value="<?php echo $list[purchaseRequisitionCashDetailAmount] ?>"/></td>
                  <th><a href="Javascript:void(0);"  id="addScnt" onclick='requisition.select(1);' class='fa fa-plus-square-o' style="color:green; float:left; padding-right:10px"></a></th>
                </tr>
          
                  <input name="item[itemID][<?php echo $key + 1 ?>]" type="hidden" size="5" class="form-control" value="<?php echo $list[purchaseRequisitionCashDetailId] ?>"/>
                ...
                <tr>
                  ...
                  <?php else: ?>
                  <input type="text" size="70" class="form-control" name= "amount"  value="<?php echo $cashadvance[0][purchaseRequisitionCashAdvanceTotal] ?>"/></td>
                  <?php endif; ?>
                  <td></td>
                  <td></td>
                  <td></td>                  
            ...
            <div class='col-sm-12'>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                  <?php if (count($cashadvance) == 0): ?>
                  <button name="check" type="submit" class="btn btn-sm btn-default" value="1">Submit</button>
                  <?php else: ?>
                  <button name="check" type="submit" class="btn btn-sm btn-default" value="2">Done</button>
                  <?php endif; ?>
