...
$routes['api-autodailyverify'] = Array('api/autodailyverify', 'controller=api:cronjob@autoDailyVerify');
...
$routes[]	= Array("[:site-slug]/profile/transactionPointList","controller=member@viewTransactionPointList");
