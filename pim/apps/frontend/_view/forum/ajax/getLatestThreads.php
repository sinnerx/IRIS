...
$profileUrl	= url::base(url::createByRoute("profile",Array("userID"=>$row['forumThreadCreatedUser'])));
?>
<li class="clearfix">
	...
	<div class="forum-category-details">
	  ...
	  <div class="forum-category-info"> Oleh:  <a href="<?php echo $profileUrl;?>"><?php echo $name;?></a>, <?php echo $date;?>, dalam <a href="<?php echo $cat_url;?>"><?php echo $res_categories[$row['forumCategoryID']]['forumCategoryTitle'];?></a></div>
	</div>
