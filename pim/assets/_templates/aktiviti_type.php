...
<h3 class="block-heading">Kalendar Aktiviti <span class="subheading"> > Jenis Aktiviti</span></h3>
...
<div class="select-activity-type"><select class="dropdown" tabindex="9" data-settings='{"wrapperClass":"flat-type"}'>
						<option value="1">Tukar Jenis Aktiviti</option>
						<option value="2">Aktiviti 1</option>
						<option value="3">Aktiviti 2</option>
						<option value="4">Aktiviti 3</option>
			
					</select></div>

<div class="calendar-heading-month">Kursus / Latihan</div>
...
<div class="prev-year"><a href="#"><i class="fa fa-angle-left"></i></a></div>
<div class="year-count">2014</div>
<div class="next-year"><a href="#"><i class="fa fa-angle-right"></i></a></div>
