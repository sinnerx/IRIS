...
<head>
<meta charset="UTF-8">
<title>Album - Perasmian Ruangan Baru</title>
...
<h3 class="block-heading">Galeri Foto <span class="subheading"> > Album > Foto</span></h3>
...
<h4 class="album-heading">Perasmian Ruangan Baru</h4>
...
<section class="slider">
        ...
        <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 2400%; transition-duration: 0s; transform: translate3d(-4632px, 0px, 0px);">
            <li style="width: 772px; float: left; display: block;" class="">
            ...
            <li style="width: 772px; float: left; display: block;">
  	    	    <img src="images/kitchen_adventurer_cheesecake_brownie.jpg" draggable="false">
  	    		</li>
  	    		<li style="width: 772px; float: left; display: block;" class="">
  	    	    <img src="images/kitchen_adventurer_lemon.jpg" draggable="false">
  	    		</li>
  	    		<li style="width: 772px; float: left; display: block;" class="flex-active-slide">
  	    	    <img src="images/kitchen_adventurer_donut.jpg" draggable="false">
  	    		</li>
  	    		<li style="width: 772px; float: left; display: block;">
  	    	    <img src="images/kitchen_adventurer_caramel.jpg" draggable="false">
          ...
          </ul></div><ul class="flex-direction-nav"><li><a href="#"><i class="fa fa-angle-left"></i></a></li><li><a href="#"><i class="fa fa-angle-right"></i></a></li></ul></div>
        <div class="flexslider thumbnail-album" id="carousel">
          
        <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 2400%; transition-duration: 0s; transform: translate3d(-1290px, 0px, 0px);">
            <li style="width: 210px; float: left; display: block;" class="">
  	    	    <img src="images/kitchen_adventurer_cheesecake_brownie.jpg" draggable="false">
  	    		</li>
  	    		<li style="width: 210px; float: left; display: block;" class="">
  	    	    <img src="images/kitchen_adventurer_lemon.jpg" draggable="false">
            ...
            <li style="width: 210px; float: left; display: block;">
  	    		...
  	    		<li style="width: 210px; float: left; display: block;" class="flex-active-slide">
  	    	    <img src="images/kitchen_adventurer_donut.jpg" draggable="false">
  	    		</li>
  	    		<li style="width: 210px; float: left; display: block;">
  	    	    <img src="images/kitchen_adventurer_caramel.jpg" draggable="false">
